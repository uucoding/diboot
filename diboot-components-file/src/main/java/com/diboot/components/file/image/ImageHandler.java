package com.diboot.components.file.image;
...
public class ImageHandler {
	 ...
	 * @param imagePath
	 */
	private static void addWatermark(String imagePath, String watermarkImagePath) throws Exception{
		Thumbnails.of(imagePath).watermark(Positions.BOTTOM_RIGHT, ImageIO.read(new File(watermarkImagePath)), 0.8f).toFile(imagePath);
    }
}
