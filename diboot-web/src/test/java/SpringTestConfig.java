...
public class SpringTestConfig implements WebMvcConfigurer {
	...
	public DataSource dataSource() {
		...
		datasource.setJdbcUrl(BaseConfig.getProperty("datasource.url"));
		datasource.setUsername(BaseConfig.getProperty("datasource.username"));
		datasource.setPassword(BaseConfig.getProperty("datasource.password"));
