...
public class JwtHelper {
    ...
    private static final String ISSUER = "dibo.ltd";
    private static final String AUTH_HEADER = "authtoken";
    private static final String TOKEN_PREFIX = "Bearer ";
    public static final String SIGN_KEY = V.notEmpty(BaseConfig.getProperty("security.jwt.signkey"))? BaseConfig.getProperty("security.jwt.signkey") : "Dibo2016Mazc";

    // 默认过期时间 2小时
    public static final int EXPIRES_IN_MINUTES = 2 * 60;
    ...
    public static String getUsernameFromToken(String token){
        return getUsernameFromToken(token, SIGN_KEY);
    }
    ...
    public static boolean isRequestTokenEffective(HttpServletRequest request){
        ...
        if(V.notEmpty(authToken)){
            ...
            if(V.notEmpty(username)){
                return BaseHelper.getCurrentUser() != null;
            }
        }
        return false;
    }
