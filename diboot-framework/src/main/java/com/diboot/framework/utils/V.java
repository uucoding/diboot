...
public class V {
	...
	public static boolean equal(Object source, Object target){
		...
		// 其他类型不一致
			...
			logger.warn("暂未实现类型 "+ source.getClass().getSimpleName() + "-"+ target.getClass().getSimpleName() + " 的比对！");
			return false;
		}
	}
	...
	/***
	 * 添加到list（如果list为空则初始化）
	 * @param itemList
	 * @param itemValue
	 * @return
	 */
	public static List addToList(List itemList, Object itemValue){
		if(itemList == null){
